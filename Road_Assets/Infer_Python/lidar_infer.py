...
from demo import *
from xy.funcs_lidar import generate_txt_path, get_timestamp, display_image, get_seg_result, mytrack, get_ip_addresses, \
    process_lidar_point_cloud, read_camera_parameters_from_yaml, setup_rtsp_stream, publish_processed_image, check_image_dynamic_early_stop
...
class ImageSubscriber(Node):
    ...
    def process_images(self):
        ...
        self.handle_segmentation(seg, lidar_point, cv_image, imagestamp,lidarstamp)
    ...
    def handle_segmentation(self, seg, lidar_point, cv_image,  imagestamp,lidarstamp):
        ...
        with open(self.txt, 'a') as file:
            ...
            if seg and len(seg[0]) != 0:
                ...
                get_seg_result(seg, lidar_point, cv_image, file, self.Model, imagestamp, self.K, self.opt.show_cloud_point)
